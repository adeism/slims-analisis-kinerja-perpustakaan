...
@media print {
    .non-printable, .menuBox, .pakpi-filter-box, .btn {
    ...
    <div class="menuBoxInner reportIcon">
        ...
        <div class="sub_section">
            <div class="text-muted small">
                <?= __('Perhitungan metrik kinerja perpustakaan berdasarkan standar SNI ISO 2789:2013.') ?>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="pakpi-card pakpi-filter-box non-printable">
        <div class="pakpi-card-body p-3">
            <form method="get" action="<?= pakpiAdminUrl() ?>" class="inline-form submitViaAJAX d-flex align-items-center flex-wrap" style="gap: 15px;">
                ...
                <a href="<?= pakpiAdminUrl(['action' => 'export_csv', 'tahun' => $tahun, 'include_renewal' => $include_renewal ? 1 : 0, 'only_active_members' => $only_active_members ? 1 : 0]) ?>" class="btn btn-success btn-sm px-3 py-1 font-weight-bold notAJAX" target="_blank">
    ...
    <div class="pakpi-card">
        ...
        <div class="pakpi-card-body">
            <div class="pakpi-desc">
                <strong>Definisi SNI ISO 2789:2013:</strong> Jumlah total peminjaman dalam koleksi selama 1 tahun dibagi dengan jumlah total eksemplar/judul. Menilai tingkat intensitas dan perputaran pemanfaatan fisik buku.
            </div>
    ...
    <div class="pakpi-card">
        ...
        <div class="pakpi-card-body">
            <div class="pakpi-desc" style="background: #eff6ff; border-left-color: #3b82f6;">
                <strong>Definisi SNI ISO 2789:2013:</strong> Jumlah total peminjaman dalam setahun dibagi dengan jumlah populasi anggota yang dilayani. Menilai rata-rata konsumsi bacaan per pemustaka.
            </div>
    ...
    <div class="pakpi-card">
        ...
        <div class="pakpi-card-body">
            <div class="pakpi-desc" style="background: #fffbeb; border-left-color: #f59e0b;">
                <strong>Definisi SNI ISO 2789:2013:</strong> Persentase dokumen/eksemplar yang tidak pernah dipinjam selama periode tahun tersebut. Menggambarkan efektivitas pengadaan dan relevansi koleksi dengan pemustaka.
            </div>
    ...
    <div class="pakpi-card">
        ...
        <div class="pakpi-card-body">
            <div class="pakpi-desc" style="background: #f5f3ff; border-left-color: #8b5cf6;">
                <strong>Definisi SNI ISO 2789:2013:</strong> Jumlah total kehadiran/kunjungan ke perpustakaan dalam setahun dibagi dengan jumlah anggota. Menilai daya tarik ruang dan layanan perpustakaan.
            </div>
